...
#     """
#     Transforms raw API JSON into structured data
#     for competitors and competitor_rankings tables.
#     """

#     competitors = []
#     rankings = []

#     seen_competitor_ids = set()

#     try:
#         for item in raw_data.get("rankings", []):
...
#             # Validate competitor (NOT NULL fields)
#             if not all([
#                 competitor_id,
#                 name,
#                 country,
...
#             if competitor_id not in seen_competitor_ids:
#                 competitors.append({
#                     "competitor_id": competitor_id,
#                     "name": name,
#                     "country": country,
...
#             # Validate NOT NULL ranking fields
#             if not all([
#                 ranking is not None,
#                 movement is not None,
#                 points is not None,
...
#             ]):
#                 logging.warning(
#                     f"Skipping ranking for competitor {competitor_id}"
#                 )
#                 continue

#             rankings.append({
#                 # rank_id is AUTO_INCREMENT → don’t include
#                 "ranking": ranking,
#                 "movement": movement,
#                 "points": points,
#                 "competitions_played": competitions_played,
...
#         logging.info(
#             f"Transformation complete: {len(competitors)} competitors, {len(rankings)} rankings"
#         )
